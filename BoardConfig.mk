...
TARGET_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/image-dtb
# Partitions
...
BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST := system system system_ext system_ext product product vendor vendor odm odm
